...
<div class="container shadow-lg">
    <div class="row main_color mt-5  pb-2 pt-3">
        <div class="col-sm-6">
            <div class="text-white h3 mt-1">Add Student</div>
        </div><!-- col-sm-6 end -->
        <div class="col-sm-6">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input type="text" class="form-control{{ $errors->has('father_name') ? ' is-invalid' : '' }}"
                            ...
                            value="{{ old('father_name') }}"><!-- Display Error Message -->
                ...
                <div class="row mb-4">
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input type="email" class="form-control{{ $errors->has('email_address') ? ' is-invalid' : '' }}"
                            ...
                            value="{{ old('email_address') }}"><!-- Display Error Message -->
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <input type="number" class="form-control{{ $errors->has('contact_no') ? ' is-invalid' : '' }}"
                            ...
                            value="{{ old('contact_no') }}"><!-- Display Error Message -->
                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-2">
                                <img src="{{ URL('assets/Students/images/profilePhoto.jpg') }}" class="rounded-circle"
                                    id="display_image">
